// Продолжите программу, в которой уже объявлена структура Point. Объявите после нее класс с именем PolyLine, содержащий следующие элементы:
...
public:
    ...
    void set_coords(const Point* ar, int size) {
        total = (size > max_coords) ? max_coords : size;
